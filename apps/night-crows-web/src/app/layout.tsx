...
export const metadata: Metadata = {
  metadataBase: new URL("https://nightcrows.th.gl"),
  title: "Night Crows – The Hidden Gaming Lair",
};
    ...
    <html lang="en">
      ...
      >
        <I18NProvider dict={enDictMerged}>
          <Header
            activeApp="Night Crows"
            settingsDialogContent={
              <SettingsDialogContent activeApp="Night Crows" hideAppSettings />
            }
          >
            <Link href="/">
              <Brand title="Night Crows" />
            </Link>
            <Links />
