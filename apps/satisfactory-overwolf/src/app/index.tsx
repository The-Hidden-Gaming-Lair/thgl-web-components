...
const APP = "Satisfactory";
const TITLE = "Satisfactory Map";
      ...
      <I18NProvider dict={enDictMerged}>
        <TooltipProvider>
          <CoordinatesProvider
            ...
            view={{}}
          >
            <AppHeader title="Satisfactory" app={APP} gameClassId={21646} />
            <HeaderOffset bypass={Boolean(isOverlay)} full>
              ...
              <Actions>
                <Whiteboard domain="satisfactory" hidden={hidden} />
                <StreamingSender domain="satisfactory" hidden={hidden} />
