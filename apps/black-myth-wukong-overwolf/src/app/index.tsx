      ...
      <I18NProvider dict={enDictMerged}>
        <TooltipProvider>
          <CoordinatesProvider
            ...
            view={{}}
          >
            <AppHeader title="Wukong" app={APP} gameClassId={24504} />
            <HeaderOffset bypass={Boolean(isOverlay)} full>
              ...
              <Actions>
                <Whiteboard domain="wukong" hidden={hidden} />
                <StreamingSender domain="wukong" hidden={hidden} />
