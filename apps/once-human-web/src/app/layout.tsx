...
export const metadata: Metadata = {
  metadataBase: new URL("https://oncehuman.th.gl"),
  title: "Once Human – The Hidden Gaming Lair",
};
    ...
    <html lang="en">
      ...
      >
        <I18NProvider dict={enDictMerged}>
          <Header
            activeApp="Once Human"
            settingsDialogContent={
              <SettingsDialogContent activeApp="Once Human" hideAppSettings />
            }
          >
            <Link href="/">
