...
export const metadata: Metadata = {
  metadataBase: new URL("https://nightingale.th.gl"),
  title: "Nightingale – The Hidden Gaming Lair",
};
    ...
    <html lang="en">
      ...
      >
        <I18NProvider dict={enDictMerged}>
          <Header
            activeApp="Nightingale"
            settingsDialogContent={
              <SettingsDialogContent activeApp="Nightingale" />
            }
          >
            <Link href="/">
              <Brand title="Nightingale" />
            </Link>
            <Links />
