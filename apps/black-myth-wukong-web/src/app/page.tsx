...
export const metadata: Metadata = {
  ...
  title: "Black Myth: Wukong Interactive Map – The Hidden Gaming Lair",
  description:
    "Explore Black Myth: Wukong with this Interactive Map! Showcasing all chapters, secrets, items, and more!",
};
