...
export const metadata: Metadata = {
  metadataBase: new URL("https://wukong.th.gl"),
  title: "Black Myth: Wukong – The Hidden Gaming Lair",
};
    ...
    <html lang="en">
      ...
      >
        <I18NProvider dict={enDictMerged}>
          <Header
            activeApp="Black Myth: Wukong"
            settingsDialogContent={
              <SettingsDialogContent activeApp="Black Myth: Wukong" />
            }
          >
            <Link href="/">
              <Brand title="Wukong" />
