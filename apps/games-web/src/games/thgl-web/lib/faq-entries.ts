...
2. Pick the site you tracked on, follow the on-screen steps to export from it (see below), then paste or upload the result.
...
## Good to know
- Only marker types we have on our map can be matched (e.g. chests, tidal heritages, sonance caskets, collectibles, echoes). Anything we don't track, or areas not yet supported, is skipped — the dialog tells you how many.
