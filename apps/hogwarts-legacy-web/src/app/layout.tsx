...
export const metadata: Metadata = {
  metadataBase: new URL("https://hogwarts.th.gl"),
  title: "Hogwarts Legacy – The Hidden Gaming Lair",
};
    ...
    <html lang="en">
      ...
      >
        <I18NProvider dict={enDictMerged}>
          <Header
            activeApp="Hogwarts Legacy"
            settingsDialogContent={
              <SettingsDialogContent activeApp="Hogwarts Legacy" />
            }
          >
            <Link href="/">
              <Brand title="Hogwarts" />
            </Link>
            <Links />
            <Account appId="ejpjngplofkhhplmlfdhlaccobehhefmgbbojdno" />
          </Header>
          <TooltipProvider>{children}</TooltipProvider>
        </I18NProvider>
        <PlausibleTracker
          apiHost="https://metrics.th.gl"
          domain="hogwarts.th.gl"
        />
        <Toaster />
      </body>
    </html>
