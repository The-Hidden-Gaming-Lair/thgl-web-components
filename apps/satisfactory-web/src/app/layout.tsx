...
export const metadata: Metadata = {
  metadataBase: new URL("https://satisfactory.th.gl"),
  title: "Satisfactory – The Hidden Gaming Lair",
};
    ...
    <html lang="en">
      ...
      >
        <I18NProvider dict={enDictMerged}>
          <Header
            activeApp="Satisfactory"
            settingsDialogContent={
              <SettingsDialogContent activeApp="Satisfactory" />
            }
          >
            <Link href="/">
              <Brand title="Satisfactory" />
            </Link>
            <Links />
