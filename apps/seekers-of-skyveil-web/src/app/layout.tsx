...
export const metadata: Metadata = {
  metadataBase: new URL("https://seekers.th.gl"),
  title: "Seekers of Skyveil – The Hidden Gaming Lair",
};
    ...
    <html lang="en">
      ...
      >
        <I18NProvider dict={enDictMerged}>
          <Header
            activeApp="Seekers of Skyveil"
            settingsDialogContent={
              <SettingsDialogContent activeApp="Seekers of Skyveil" />
            }
          >
            <Link href="/">
              <Brand title="Seekers" />
