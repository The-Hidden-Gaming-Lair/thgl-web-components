...
const APPS = [
  {
    ...
    partners: [
      {
        title: "Dune Awakening Database",
        url: "https://dune.gaming.tools/",
        icon: "https://www.th.gl/global_icons/gaming-tools.webp",
      },
      {
        title: "r/duneawakening",
  ...
  },
  {
    ...
    url: "https://dragonwilds.th.gl",
    icon: "https://www.th.gl/global_icons/rsdragonwilds.webp",
    tags: ["interactive_map"],
  },
  {
    title: "Avowed",
    url: "https://avowed.th.gl",
    icon: "https://www.th.gl/global_icons/avowed.webp",
    tags: ["interactive_map"],
  },
  {
    title: "Infinity Nikki",
    url: "https://infinitynikki.th.gl",
    icon: "https://www.th.gl/global_icons/infinity-nikki.webp",
    tags: ["interactive_map"],
  },
  {
    title: "Satisfactory",
    url: "https://satisfactory.th.gl",
    icon: "https://www.th.gl/global_icons/satisfactory.webp",
    tags: ["interactive_map"],
  },
  {
    title: "Stormgate",
    url: "https://stormgate.th.gl",
    icon: "https://www.th.gl/global_icons/stormgate.webp",
    tags: ["interactive_map", "server_status"],
  },
  {
    title: "Wuthering Waves",
    url: "https://wuthering.th.gl",
    icon: "https://www.th.gl/global_icons/wuthering-waves.webp",
    tags: ["interactive_map"],
  },
  {
    title: "Pax Dei",
    url: "https://paxdei.th.gl",
    icon: "https://www.th.gl/global_icons/pax-dei.webp",
    tags: ["interactive_map"],
    partners: [
      {
      ...
      },
      {
        ...
        icon: "https://www.th.gl/global_icons/paxdei-tools.webp",
      },
      {
        title: "Pax Clans",
        url: "https://paxclans.com/?ref=thgl",
        icon: "https://www.th.gl/global_icons/paxclans.webp",
      },
      {
        title: "Guides",
        url: "https://mmo-wiki.com/pax-dei/?ref=thgl",
        icon: "https://www.th.gl/global_icons/mmo-wiki.webp",
      },
    ],
  },
  {
    ...
    icon: "https://www.th.gl/global_icons/night-crows.webp",
    tags: ["interactive_map"],
    partners: [
      {
  ...
  },
  {
    ...
    icon: "https://www.th.gl/global_icons/aeternum-map.png",
    tags: ["interactive_map"],
  },
  {
    title: "New World Tracker",
    url: "https://aeternum-tracker.th.gl",
    icon: "https://www.th.gl/global_icons/aeternum-tracker.webp",
    tags: ["activity_tracker"],
  },
  {
    title: "Diablo IV",
    url: "https://diablo4.th.gl",
    icon: "https://www.th.gl/global_icons/diablo4.webp",
    tags: ["interactive_map"],
    partners: [
      {
        title: "D4 Armory",
        url: "https://d4armory.io/?ref=thgl",
        icon: "https://www.th.gl/global_icons/d4armory.webp",
      },
      {
        title: "Diablo IV Companion",
        url: "https://github.com/josdemmers/Diablo4Companion?ref=thgl",
        icon: "https://www.th.gl/global_icons/diablo4companion.webp",
      },
    ],
  },
  {
    ...
    icon: "https://www.th.gl/global_icons/hogwarts-legacy.webp",
    tags: ["interactive_map"],
  },
  {
    title: "League of Legends",
    url: "https://lol.th.gl",
    icon: "https://www.th.gl/global_icons/league-of-legends.webp",
    tags: ["challenges"],
  },
  {
    title: "Once Human",
    url: "https://oncehuman.th.gl",
    icon: "https://www.th.gl/global_icons/once-human.webp",
    tags: ["interactive_map"],
  },
  {
    title: "Palia",
    url: "https://palia.th.gl",
    icon: "https://www.th.gl/global_icons/palia.webp",
    ...
    partners: [
      ...
      },
      {
        ...
        icon: "https://www.th.gl/global_icons/palia-tracker.webp",
      },
    ],
  },
  {
    ...
    icon: "https://www.th.gl/global_icons/palworld.webp",
    tags: ["interactive_map"],
    partners: [
      {
        title: "Palworld Soundboard",
        url: "https://www.voicy.network/official-soundboards/games/palworld",
        icon: "https://www.th.gl/global_icons/voicy.webp",
      },
      {
        title: "r/Palworld",
      ...
      },
      {
        ...
        icon: "https://www.th.gl/global_icons/wiki-gg.webp",
      },
      {
  ...
  },
  {
    ...
    url: "https://soc.th.gl",
    icon: "https://www.th.gl/global_icons/songs-of-conquest.webp",
    tags: ["database"],
  },
  {
    title: "Sons of the Forest",
    url: "https://sotf.th.gl",
    icon: "https://www.th.gl/global_icons/sons-of-the-forest.webp",
    tags: ["interactive_map"],
  },
];
