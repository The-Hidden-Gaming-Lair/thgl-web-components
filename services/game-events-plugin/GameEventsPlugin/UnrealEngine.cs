...
namespace GameEventsPlugin
{
  ...
  public class UEObject
  {
    ...
    public static int fieldOffset = 0x44; // 0x4C;
    ...
    public static String GetName(Int64 key)
    {
      if (ClassIndexToName.ContainsKey(key))
      {
        return ClassIndexToName[key];
      }
      var namePtr = UnrealEngine.Memory.ReadProcessMemory<Int64>((IntPtr)(UnrealEngine.GNames.ToInt64() + ((key >> 16) + 2) * 8));
      if (namePtr == 0)
      {
        ClassIndexToName[key] = "badIndex";
        return "badIndex";
      }
      var nameEntry = UnrealEngine.Memory.ReadProcessMemory<UInt16>((IntPtr)(namePtr + (key & 0xffff) * 2));
      ...
      string result = UnrealEngine.Memory.ReadProcessMemory<String>((IntPtr)(namePtr + (key & 0xffff) * 2 + 2));
    ...
    public String GetName()
    {
      ...
      var classNameIndex = UnrealEngine.Memory.ReadProcessMemory<Int64>(classPtr + nameOffset);
