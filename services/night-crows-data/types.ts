export type MSubZoneData = Array<{
  ...
  Rows: {
    ...
    ContentTest_Sz_SiegeCenterArea: {
      Title: {
        StringId: string;
      };
      Airship: {
